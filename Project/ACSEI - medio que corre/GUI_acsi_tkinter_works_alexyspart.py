...
# from Primer_Modo import segmentation
import numpy     as     np
import threading
import datetime
import ultralytics
...
#                    self.imgPieD.image = photo
    ...
    def segmentacion(self):
        ...
        # self.imagesList[2][0], self.imagesList[3][0] = segmen_tacion(self.imagesList[2][0], self.imagesList[3][0])

        # self.imagesList[2][1] = ImageTk.PhotoImage(self.imagesList[2][0])
        # self.imagesList[3][1] = ImageTk.PhotoImage(self.imagesList[3][0])
        print(self.imagesList[0][0])
        print(self.imagesList[0][1])
        print(self.imagesList[1][0])
        print(self.imagesList[1][1])
