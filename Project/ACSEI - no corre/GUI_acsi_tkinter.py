...
from Segmentation import segmen_tacion
from YOLO_ML     import YOLO_pie, apply_mask_with_alpha
import numpy      as     np
import threading
import datetime
import _thread
...
#                    self.imgPieD.image = photo
    ...
    def segmentacion(self):
        # Lo grande va aquí
        # self.imagesList[2][0] = YOLO_pie(self.imagesList[0][0])
        # self.imagesList[3][0] = YOLO_pie(self.imagesList[1][0])
        
        # self.imagesList[2][0], self.imagesList[3][0], self.max_tp = segmentation(self.imagesList[2][0], self.imagesList[3][0])
        self.imagesList[2][0], self.imagesList[3][0], self.max_tp = segmentation(self.imagesList[0][0], self.imagesList[1][0])

        self.imagesList[2][1] = ImageTk.PhotoImage(self.imagesList[2][0])
        self.imagesList[3][1] = ImageTk.PhotoImage(self.imagesList[3][0])
    ...
    def save(self):
        ...
        if self.max_tp == 1:
            print('Mayor temperatura en pie izquierdo')
        else:
            print('Mayor temperatura en pie derecho')
...
if __name__ == '__main__':
    print('Llego aquí')
    window = DiabeApp()
    print('Y aquí también')
    window.mainloop()
    print('Mira Maricris lo logré')
